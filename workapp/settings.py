...
INSTALLED_APPS = [
    ...
    'rest_framework', # add
    'workapp_api.apps.WorkappApiConfig',# add
    'corsheaders', # add
    'djoser', # add
]
...
CORS_ORIGIN_WHITELIST = [
    "http://localhost:3000", # Next.jsのローカルサーバー
]

SIMPLE_JWT = {
    'AUTH_HEADER_TYPES': ('JWT',),
    'ACCESS_TOKEN_LIFETIME': timedelta( minutes = 300) #分単位で設定
}
...
STATIC_URL = '/static/'
STATIC_ROOT = str(BASE_DIR / 'staticfiles') # add
